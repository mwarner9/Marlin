...
#define EXTRUDER_AUTO_FAN_SPEED 126   // 255 == full speed
...
//#define ASSISTED_TRAMMING
  ...
  #define TRAMMING_POINT_XY { {  50, 50 }, {X_BED_SIZE-50,  50 }, { X_BED_SIZE-50, Y_BED_SIZE-50 }, { 20, Y_BED_SIZE-50 } }
...
#define INPUT_SHAPING_Y
    ...
    #define SHAPING_FREQ_X  30.80          // (Hz) The default dominant resonant frequency on the X axis.
    #define SHAPING_ZETA_X  0.15f       // Damping ratio of the X axis (range: 0.0 = no damping to 1.0 = critical damping).
  #endif
  #if ENABLED(INPUT_SHAPING_Y)
    #define SHAPING_FREQ_Y  26.80          // (Hz) The default dominant resonant frequency on the Y axis.
